  ...
  public async checkByPAN(pan: string, ipo: IPO): Promise<AllotmentResult> {
    ...
    return this.limiter.schedule(async () => {
      try {
        ...
        logger.warn({ provider: this.name, error: (error as Error).message }, 'BSE check failed');
